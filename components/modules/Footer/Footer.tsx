                ...
                <div className={styles.footer__top}>
                    ...
                    <div className={styles.footer__top__item}>
                        ...
                        <ul className={`${styles.footer__top__item__list} ${styles.footer__top__item__contacts}`}>
                            ...
                            <li className={styles.footer__top__item__list__item}>
                               <a href='tel:+380675555555' className={styles.footer__top__item__list__item__link}>
                                    <span>Наш контактный телефон:</span>
                                    <span>+3(8067) 555-55-55</span>
                                    <span><PhoneSvg/></span>
                                </a>
                            </li>
                            <li className={styles.footer__top__item__list__item}>
                               <a href='mailto:info@zapchasti.com.ua' className={styles.footer__top__item__list__item__link}>
                                    <span>E-mail:</span>
